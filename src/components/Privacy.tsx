        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-4xl mx-auto py-8 px-4">
                ...
                <div className="space-y-6">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-800 mb-4">4. 정보주체의 권리·의무 및 행사방법</h2>
                        <p className="text-gray-600">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-800 mb-4">5. 개인정보의 안전성 확보조치</h2>
                        <p className="text-gray-600">
